...
export default function TeamPage() {
    ...
    <>
     ...
     <p className="text-black-800 mb-10">Meet our team, which aims at cultivating, drilling & growing our community to enrich & prosper the overall tech culture, be a member and contribute to be include in our team.</p>
